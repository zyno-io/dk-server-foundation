...
| [DevConsole](./devconsole.md) | Built-in web dashboard for development: HTTP inspector, SRPC monitor, database entity browser, database query log, REPL, worker/mutex/health views, and more. |
